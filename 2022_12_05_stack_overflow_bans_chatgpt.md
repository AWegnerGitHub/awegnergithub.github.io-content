...
"good thing". With their examples, it definitely looks that way. But, in practice, it's not working out so well.
...
explanation that _looks_ plausible. But, it's wrong. Combined with users posting multiple answers an hour, this is
...
ensure the community we have volunteered to moderate remains one of high quality. Additionally, as the larger [Stack Exchange 
