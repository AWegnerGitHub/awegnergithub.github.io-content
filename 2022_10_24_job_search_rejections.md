...
Rejection during a job search is part of the process. Companies only have so many openings to fill. As a candidate, you put hours of time into your goal of getting a role and then, unfortunately, the dreaded rejection shows up. It happens, but it'd be nice if it was useful so that you can move on to the next role and make improvements.
