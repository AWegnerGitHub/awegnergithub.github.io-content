Title: Review of Learn Github Actions for CI/CD DevOps Pipelines Course
...
As for the content of the course, it doesn't match what I was expecting. With the "All beginners" advertisement, I was expecting more discussion and coverage on _why_ certain things were being done. A discussion on the trade offs or the instructor's thought process on how to accomplish tasks.
...
If my coupon hadn't knocked off the entire price of the course, I'd be upset with this one. I also picked up two other courses by this instructor and I suspect I'm going to find similar concerns with those courses. Honestly, that's too bad, because the content is good. It's just not marketed how it's packaged. With my expectations set for learning a bit, it's disappointing to get lectures that are designed to be copy and pasted from.
