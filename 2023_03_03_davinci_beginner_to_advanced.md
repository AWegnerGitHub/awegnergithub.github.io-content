...
I decided to take beginner course to learn some more about the product. Spoiler: I'm even more impressed by Resolve and at the same
time know that I have learned only a tiny fraction of what its true capabilities are. There is so much to learn about individual
...
and discourages deviations for that in a few places. The most notable one is avoiding the use of the "Cut" tab all together, and instead 
...
and "Fusion". "Color" gets a section of lectures, but I felt this was more a demonstration of capabilities than an explanation of why something is 
occurring. To be fair to the author, I think they realize that their audience (ie. me) aren't professional editors or have color grading training or 
...
The author is using DaVinci Resolve 18, which at the time I took the course was the most recent version. I had a minor release update, but many other 
courses I saw on Udemy were for older versions of Resolve. One of the things I didn't like about the Unreal courses was that the instructor used early access or beta versions of the tool, while I was utilizing a full release, so the UI was not always the same. 
...
wouldn't work as expected. They'd redo it and it'd work. The first attempt would be vaguely glossed over and the instructor would move on. I think
the failure would have been removed from the lecture, with a minimal impact on understanding of the concept.

The projects we did involved a lot of watching the instructor click around the screen while the student was, theoretically, following along. I think this
...
Focusing on the lecture at the same time I was focusing on my project wasn't possible. I think a better way to present this would have been a short 
...
gets louder. For a while I thought it was either my computer (it wasn't) or my headphones (again, it wasn't). My suggestion to the author is to apply a bit of noise cancellation to the frequency your fan operates at, because with headphones it is very clear that the fan is running.
...
that it's my first project. I can already think of several other projects I can use Resolve for and I feel comfortable using it for these personal
 projects.
...
jump cuts. It gets..."jarring" is perhaps the best way to describe it. But, this was the editing style the instructor went with. I'd love to learn about other options so that it feels less jarring.
