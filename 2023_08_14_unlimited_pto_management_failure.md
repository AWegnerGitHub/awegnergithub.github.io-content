...
Summary: Unlimited PTO is a perk more and more organizations are offering their employees. Unfortunately, many managers and organizations are managing this poorly and failing their employees. What does this management failure look like?
Status: published
...
unlimited PTO because it reduces benefit package negotiations over vacation time. Theoretically, it should help fight employee burn out too because 
...
"Unlimited" doesn't truly mean "unlimited". An employee isn't going to get 6 months of vacation approved by management. A 
...
One of the jobs of a manager of teams is to prevent too many overlapping vacations. With an unlimited policy, how do you justify allowing one person
...
I've worked at companies that have "unlimited PTO", a set number of days of PTO and "minimum number of days of PTO". Personally, I prefer the last two.
Unlimited PTO - as an employee - very quickly becomes a game of determining how much is too much, and stressing out about having time off denied over a 
vague policy. 
...
The last option is, essentially setting a minimum and maximum number of days to take off. This isn't _quite_ "unlimited", but in my experience was 
labeled that with an asterisk. The important part though is that the company required you to take a minimum amount of time off and it had to be in
...
Instead I took fewer days than my defined policy had allowed and even lost some company holidays that the previous employer had that the new one did 
