Title: Review of Claude Code for Python Developers from Real Python
Date: 2026-04-06 10:30
Tags: review, technical, learning
Category: Review
Slug: real-python-claude-code-live-course
Summary: A review of the Real Python live workshop - Claude Code for Python Developers: Hands-on agentic coding course
Status: published
Series: Course Reviews
Provider: RealPython
template: review
revieweditem: Claude Code for Python Developers: Hands-on agentic coding course
score: 9.0
price: 800.00
saleprice: 499
workload: PT8H
...
If you are in the software industry and haven't started working with an AI assistant by this point in 2026, then you should start getting concerned about your role in the company you work at. [Throughout the first few months of 2026][6], there have been several large layoffs by major corporations. [Companies like Block and Oracle cited AI as the driver][7].

AI is here and as of today, it's the least capable it will ever be, because each day it gets better. I've been exploring it since ChatGPT came out and it's [impact on interviews][1]. I've written about it multiple times recently. [AI's impact on junior developers][2] is particularly important because I'm already seeing this in my role. 
...
I feel like I've only _touched_ the surface - not even scratched it - touched the surface of how to better use AI tooling, and I've been using it a lot. So, I looked for a workshop to increase my knowledge. As a subscriber to [Real Python][3], I was happy to see they offered a brand new workshop about [Claude Code][4] and as of this writing they are offering it again.

The course - [Claude Code for Python Developers: Hands-On Agentic Coding Course][course]. A bit wordy, but an amazing two days.
...
![My review of the Real Python Claude Code workshop that I endorse][reivew]
...
1. Learn something for myself that I could take and apply to personal projects
2. Learn something for my teams so that we could use it as inspiration to make further improvements to our workflows
...
[![Real Python Claude Code for Python Developers: Hands-on Agentic Coding certificate of completion][certificate]][courselink]


 [course]: https://realpython.com/workshops/claude-code/
 ...
 [5]: https://realpython.com/team/pacsany/
 [6]: https://www.cfodive.com/news/ai-tied-a-quarter-us-layoffs-march/816519/
 [7]: https://programs.com/resources/ai-layoffs/