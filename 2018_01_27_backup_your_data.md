...
soccer season had just ended so I had time on weekends to do a few more projects. Then in mid-October one of my hard drives died. It was sudden. There were
no SMART warnings. There weren't any weird sounds.

In fact, the only indication that there was a problem initially was that one of my running applications couldn't access a log file. I didn't think anything of it.
...
On my desktop, I have three hard drives. The first is a decently sized solid state machine that hosts the operating system. The second is a large solid state drive that
...
camera SD cards," I said, trying to comfort myself. I also knew I had at least two brand new and unused drives identical to the one that had just had a problem. Those were the
result of cheap hard drives when I built my desktop and the promise that one day I'd build a true backup solution for the house. Yeah, hadn't done that yet.
...
frustration and plugged one of its unused siblings in.
...
copying data back into place. I breathed a sigh of relief when all the family pictures were restored. I lost a weekend, but everything looked good. I went to bed Sunday night
...
More than a decade worth of personal programming projects, horrible attempts at graphic work (seriously...graphics aren't my thing), notes for games that I'd love to design if
...
That's what I tried. I hoped it'd work. Windows still couldn't see the bad drive. A Linux LiveCD could see that a drive existed, but couldn't find any data. That was still
progress. I ran software for almost two days as it tried to find anything for me to recover.
...
I went with a professional. I couldn't lose that much of my history. I still need those projects for both personal and professional work.
...
It's been a little over a month since I've transferred my data to the new drive in my desktop. I've manually run my back up process two or three times. I'm pretty much where
