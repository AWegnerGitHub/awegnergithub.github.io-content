...
Summary: Approximately 10% of links on Stack Overflow are unavailable. This is an analysis of how I determined that and a discussion on how to improve it.
Status: published
...
4. There where 7 total URLs that returned status codes in the `600` and [`700`][10] range. One such site was [code.org][11] with a status code of 752. Sadly, this is not even defined in the joke RFC.
